const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/search-docs-data-B3HumPmh.js","assets/vendor-fM6oQU9V.js"])))=>i.map(i=>d[i]);
import { n as ref, k as watch, c as computed, W as markRaw, d as defineComponent, o as openBlock, a as createElementBlock, a2 as renderSlot, v as withKeys, q as normalizeClass, y as createBlock, e as unref, I as Icon, f as createVNode, b as createBaseVNode, z as createTextVNode, t as toDisplayString, F as Fragment, x as renderList, g as createCommentVNode, l as useCssVars, Z as toRefs, $ as useRouter, p as withCtx, az as useFocus, aA as refDebounced, w as withDirectives, ae as vModelText, a8 as withModifiers, aB as Fuse, _ as __vitePreload } from "./vendor-fM6oQU9V.js";
import { o as onKeyboardShortcut, u as useCommandStore } from "./bundle-main-DKw0tAVX.js";
import { u as useStoryStore } from "./story-BZf_oyIh.js";
import "./mapping-RV74clEr.js";
import { B as BaseEmpty } from "./BaseEmpty.vue-DlYvElRp.js";
import { _ as _export_sfc, u as useScrollOnActive, B as BaseListItemLink } from "./responsive-MEwI0R00.js";
...
let searchData$1 = { "index": [{ "id": 0, "text": "button" }, { "id": 1, "text": "button default" }], "idMap": { "0": { "id": "src-button-story-vue", "kind": "story" }, "1": { "id": "src-button-story-vue:src-button-story-vue-0", "kind": "variant" } } };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const DocSearchData = () => __vitePreload(() => import("./search-docs-data-B3HumPmh.js"), true ? __vite__mapDeps([0,1]) : void 0);
    const props = __props;
    const emit = __emit;
    function close() {
      emit("close");
